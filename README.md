...
| [tmux-claude-finder ↗](https://github.com/wateret/tmux-claude-finder) | tmux plugin | Search across live Claude Code foreground sessions in tmux and jump to the matching pane |
